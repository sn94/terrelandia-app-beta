...
export default function index({ gastos_administrativos, comisiones_vendedores,otros_gastos }) {  
    ...
    return    <View style={{ marginTop: 10 ,marginBottom:10,height: 110, backgroundColor:"white", ... styles.column  }}>
            ...
            <Text style={styles.NormalText}>Gastos administrativos</Text>
                <Text style={styles.NormalText}> {gastos_administrativos}</Text>
            </View>
            <View style={styles.row}>
            <Text style={styles.NormalText}>Comisiones de vendedores</Text>
                <Text style={styles.NormalText}> { comisiones_vendedores}</Text>
            </View>
            <View style={styles.row}>
